...
const Panic = require('../models/ConselhoCIC_Panic');
...
router.post('/close', async (req, res) => {
    try {
        let user = await User.findById(req.body.UserRequest);
        user.InPanic = 'false';
        user.save();
...
module.exports = app => app.use('/conselho-cic/panic', router);